...
read_path_live <- file.path("/Users", "kmacdonald", "Documents", 
                       "Projects", "SOC_XSIT", "processed_data", 
                       "adult-live/")
...
d6 <- tbl_df(read.csv(paste(read_path_live,
                            "soc_xsit_live.csv", sep ="")))
```
...
d6 <- mutate(d6, experiment = "live")

# wrap in list 
d.list <- list(d, d1, d2, d3, d4, d5, d6)
