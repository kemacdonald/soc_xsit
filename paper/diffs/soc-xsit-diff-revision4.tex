...
%DIF DEL soc-xsit-elsevier-revision-draft3.tex   Fri Sep 30 13:44:16 2016
%DIF ADD soc-xsit-elsevier-revision-draft4.tex   Mon Oct  3 14:49:03 2016
...
Referent X 2 Intervals X 2 Gaze conditions) for \DIFaddbegin \DIFadd{a }\DIFaddend total of 400 paid HITs
(33 HITs excluded).
...
\begin{tabular}{lrrrrl}
 Predictor & Estimate & Std. Error & $z$ value & $p$ value &  \\ 
  \hline
Intercept & \DIFdelbeginFL \DIFdelFL{2.94 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{4.04 }\DIFaddendFL & 0.18 & \DIFdelbeginFL \DIFdelFL{16.00 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{21.97 }\DIFaddendFL & $<$ .001 & *** \\ 
...
interaction \DIFdelbegin \DIFdel{betweeen }\DIFdelend \DIFaddbegin \DIFadd{between }\DIFaddend gaze condition and inspection time that we found in
...
it. The \DIFaddbegin \DIFadd{\(\beta\) value for the }\DIFaddend interaction between trial type and
reliability \DIFdelbegin \DIFdel{was no longer
significant in this model (\(\beta = -0.62\), }\DIFdelend \DIFaddbegin \DIFadd{changed from -0.76 to -0.62, (}\DIFaddend \(p\) = 0.086)\DIFdelbegin \DIFdel{, suggesting
that }\DIFdelend \DIFaddbegin \DIFadd{. This reduction
suggests that participants' use of gaze may be a stronger predictor of
}\DIFaddend the effect of reliability on learners' memory for alternative
word-object links\DIFdelbegin \DIFdel{is driven by whether participants chose to use the
gaze cue during learning}\DIFdelend .\footnote{We are grateful to an anonymous reviewer for
...
exposure trials and trial type (\DIFdelbegin \DIFdel{\(\beta = -0.32\)}\DIFdelend \DIFaddbegin \DIFadd{\(\beta = -0.26\)}\DIFaddend , \(p\) \textless{}
...
Figure 5).\footnote{We found this interaction while performing
  ...
  independent sample (N = 250, \DIFdelbegin \DIFdel{\(\beta = -0.29\)}\DIFdelend \DIFaddbegin \DIFadd{\(\beta = -0.24\)}\DIFaddend , \(p\) \textless{}
...
\begin{tabular}{lrrrrl}
 term & estimate & std.error & z.value & p.value &  \\ 
  \hline
Intercept & \DIFdelbeginFL \DIFdelFL{2.41 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3.51 }\DIFaddendFL & 0.29 & \DIFdelbeginFL \DIFdelFL{8.34 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{12.13 }\DIFaddendFL & $<$ .001 & *** \\ 
...
\begin{tabular}{lrrrrl}
 term & estimate & std.error & z.value & p.value &  \\ 
  \hline
Intercept & \DIFdelbeginFL \DIFdelFL{1.97 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3.07 }\DIFaddendFL & 0.98 & \DIFdelbeginFL \DIFdelFL{2.02 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3.14 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{0.044 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.002 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{* }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{** }\DIFaddendFL \\ 
  Reliability Condition & 3.28 & 1.50 & 2.19 & 0.029 & * \\ 
  Subjective Reliability & 7.26 & 1.73 & 4.21 & $<$ .001 & *** \\ 
  Reliability Condition*Subjective Reliability & -4.58 & 2.72 & \DIFdelbeginFL \DIFdelFL{-1.68 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{-1.69 }\DIFaddendFL & 0.092 & . \\ 
   \hline
\end{tabular}
\label{tab:e3_gf_exp}
\end{table}
...
\begin{tabular}{lrrrrl}
 term & estimate & std.error & z.value & p.value &  \\ 
  \hline
Intercept & \DIFdelbeginFL \DIFdelFL{3.61 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{4.70 }\DIFaddendFL & 0.36 & \DIFdelbeginFL \DIFdelFL{10.04 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{13.09 }\DIFaddendFL & $<$ .001 & *** \\ 
  Trial Type & -3.95 & 0.36 & \DIFdelbeginFL \DIFdelFL{-10.93 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{-10.92 }\DIFaddendFL & $<$ .001 & *** \\ 
...
\begin{tabular}{lrrrrl}
 term & estimate & std.error & z.value & p.value &  \\ 
  \hline
Intercept & \DIFdelbeginFL \DIFdelFL{3.40 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{4.50 }\DIFaddendFL & 0.39 & \DIFdelbeginFL \DIFdelFL{8.75 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{11.58 }\DIFaddendFL & $<$ .001 & *** \\ 
...
\begin{tabular}{lrrrrl}
 term & estimate & std.error & z.value & p.value &  \\ 
  \hline
Intercept & \DIFdelbeginFL \DIFdelFL{2.38 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{2.73 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{0.54 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.39 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{4.39 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{7.01 }\DIFaddendFL & $<$ .001 & *** \\ 
  Total Exposure Correct & \DIFdelbeginFL \DIFdelFL{0.19 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.14 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{0.07 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.06 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{2.65 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{2.49 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{0.008 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.013 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{** }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{* }\DIFaddendFL \\ 
  Trial Type & \DIFdelbeginFL \DIFdelFL{-2.11 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{-1.39 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{0.54 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.39 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{-3.89 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{-3.55 }\DIFaddendFL & $<$ .001 & *** \\ 
  Total Exposure Correct*Trial Type & \DIFdelbeginFL \DIFdelFL{-0.32 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{-0.26 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{0.07 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.06 }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{-4.45 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{-4.66 }\DIFaddendFL & $<$ .001 & *** \\ 
   \hline
\end{tabular}
...
\begin{tabular}{lrrrrl}
 term & estimate & std.error & z.value & p.value &  \\ 
  \hline
Intercept & \DIFdelbeginFL \DIFdelFL{3.44 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{4.54 }\DIFaddendFL & 0.44 & \DIFdelbeginFL \DIFdelFL{7.83 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{10.33 }\DIFaddendFL & $<$ .001 & *** \\ 
...
\begin{tabular}{lrrrrl}
 term & estimate & std.error & z.value & p.value &  \\ 
  \hline
Intercept & \DIFdelbeginFL \DIFdelFL{2.01 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3.11 }\DIFaddendFL & 0.20 & \DIFdelbeginFL \DIFdelFL{10.31 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{15.94 }\DIFaddendFL & $<$ .001 & *** \\ 
...
\begin{tabular}{lrrrrl}
 term & estimate & std.error & z.value & p.value &  \\ 
  \hline
Intercept & \DIFdelbeginFL \DIFdelFL{2.27 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3.37 }\DIFaddendFL & 0.16 & \DIFdelbeginFL \DIFdelFL{14.37 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{21.32 }\DIFaddendFL & $<$ .001 & *** \\ 
