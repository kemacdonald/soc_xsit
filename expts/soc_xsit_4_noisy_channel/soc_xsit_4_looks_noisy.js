 ...
 * for the 2 different gaze length conditions and the no-social condition)
 */

try {
    var filename = "KM_soc_xsit_4_looks_noisy_100";
...
exampleFaces = [['silentLUshort', 'silentLUshort', 'silentRUshort', 'silentLDshort'],
                ...
                ['noisyLU', 'noisyLU', 'noisyRU', 'noisyLD']],
...
testFaces = [['silentLDshort', 'silentLUshort', 'silentRDshort', 'silentRUshort'],
             ...
             ['noisyLD', 'noisyLU', 'noisyRD', 'noisyRU']],
