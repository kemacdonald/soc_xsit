...
try { 
    var filename = "KM_soc_xsit_reliability_parametric_pilot";
...
// Grab the correct familiarization block
if(prop_cond == "0%_reliable") {
...
//set up images used on example trials
