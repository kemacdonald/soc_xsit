...
write.csv(x = df_expt1, 
          "../../data/final/soc-xsit-expt1-finalData.csv",
          row.names = F)
```
...
pandoc.table(anova(m1_2way_expt1_unfilt, m1_3way_expt1_unfilt))
```
...
```{r expt3 histogram subjective reliablity}
...
#### Reliablity as continuous variable
...
Save final, clean dataset for manuscript.

```{r}
write.csv(x = df_expt3, 
          "../../data/final/soc-xsit-expt3-finalData.csv",
          row.names = F)
```
