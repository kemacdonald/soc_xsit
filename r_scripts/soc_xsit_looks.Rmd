...
library(dplyr)
library(xtable)
source('/Users/Allison/soc_xsit/XSIT-MIN/analysis/Ranalysis/useful.R')
```
...
## TODO relabel Test RT and Exp RT columns!!!!
...
acc_plot <- qplot(data=ms.gaze.tar,x=gazeLength, y=correct, linetype=trialType, 
